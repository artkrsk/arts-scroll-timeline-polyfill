...
export type PolyfillInset =
  | string
  | readonly (PolyfillNumericValue | PolyfillKeywordValue | 'auto')[]
...
export type PolyfillRangeInput =
  | string
  | PolyfillNumericValue
  | PolyfillKeywordValue
  | PolyfillRangeOffset
export type PolyfillTimeline = AnimationTimeline | PolyfillScrollTimeline
export interface PolyfillAnimationOptions
  extends Omit<KeyframeAnimationOptions, 'timeline' | 'rangeStart' | 'rangeEnd' | 'duration'> {
  duration?: number | 'auto'
  timeline?: PolyfillTimeline | null | undefined
  rangeStart?: PolyfillRangeInput | undefined
  rangeEnd?: PolyfillRangeInput | undefined
}
export interface PolyfillComputedTiming
  extends Omit<ComputedEffectTiming, 'localTime' | 'endTime' | 'activeDuration' | 'duration'> {
