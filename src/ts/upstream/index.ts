...
import { initArtsCSSPolyfill } from '../arts/compat.js'

// Both gates are intentional: the loader avoids the fetch, and this protects
// direct users of the delivered bundle from installing over native support.
function initPolyfill(): void {
  if (hasNativeSupport() || !hasPolyfillPrerequisites()) {
    return
  }
  ...
  if (
    !Reflect.defineProperty(Element.prototype, 'getAnimations', { value: elementGetAnimations })
  ) {
    throw Error(
