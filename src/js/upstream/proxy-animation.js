...
export function getProxyDetails(proxy) { return proxyAnimations.get(proxy); }
...
export function getProxyForNativeAnimation(animation) { return proxiedAnimations.get(animation); }
